...
BDSKComplexString *complexStringFromBTField(AST *field, 
                                            NSString *fieldName, 
                                            NSString *filePath,
...
BDSKComplexString *complexStringFromBTField(AST *field, NSString *fieldName, NSString *filePath, BibDocument* document){
