...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/SourceRelease_2005-10-03/OmniGroup/Frameworks/OmniAppKit/OAScriptToolbarHelper.m 66586 2005-08-09 17:00:47Z bungi $")
...
- (NSArray *)scriptPaths;
{
    ...
    if (OSVersionIs_10_4_Plus) {
        NSString *appSupportDirectory = [[[NSBundle mainBundle] infoDictionary]objectForKey:@"CFBundleName"];
        [result addObject:[[[[NSHomeDirectory() stringByAppendingPathComponent:@"Library"] stringByAppendingPathComponent:@"Scripts"] stringByAppendingPathComponent:@"Applications"] stringByAppendingPathComponent:appSupportDirectory]];
    } else {
        ...
        [result addObject:[[[[NSHomeDirectory() stringByAppendingPathComponent:@"Library"] stringByAppendingPathComponent:@"Application Support"] stringByAppendingPathComponent:appSupportDirectory] stringByAppendingPathComponent:@"Scripts"]];
        [result addObject:[[[[@"/" stringByAppendingPathComponent:@"Library"] stringByAppendingPathComponent:@"Application Support"] stringByAppendingPathComponent:appSupportDirectory] stringByAppendingPathComponent:@"Scripts"]];
        [result addObject:[[[[@"/Network" stringByAppendingPathComponent:@"Library"] stringByAppendingPathComponent:@"Application Support"] stringByAppendingPathComponent:appSupportDirectory] stringByAppendingPathComponent:@"Scripts"]];
...
- (void)finishSetupForItem:(NSToolbarItem *)item;
{
    ...
    FSRef myFSRef;
    if (FSPathMakeRef((UInt8 *)[[self pathForItem:item] fileSystemRepresentation], &myFSRef, NULL) == noErr) {
...
{
    NSString *scriptFilename = [self pathForItem:sender];
