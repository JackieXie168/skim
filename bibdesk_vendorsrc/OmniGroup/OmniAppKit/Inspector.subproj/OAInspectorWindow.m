...
RCS_ID("$Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniAppKit/Inspector.subproj/OAInspectorWindow.m,v 1.23 2004/02/10 04:07:33 kc Exp $");
...
- (void)setFrame:(NSRect)newFrame display:(BOOL)display animate:(BOOL)animate;
{
    ...
    if (!NSEqualRects(currentFrame, newFrame))
        ...
        // Also, callilng it too often seems to crash on 10.2 (usually the NSEqualRects check will prevent this, but you may need to avoid calling this a whole bunch during inspector startup).
