...
RCS_ID("$Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniAppKit/Widgets.subproj/OACalendarView.m,v 1.21 2003/01/15 22:51:42 kc Exp $")
...
- (id)initWithFrame:(NSRect)frameRect;
{
    ...
    monthAndYearView = [[NSView alloc] initWithFrame:NSMakeRect(0.0, 0.0, frameRect.size.width, OACalendarViewButtonHeight)];
