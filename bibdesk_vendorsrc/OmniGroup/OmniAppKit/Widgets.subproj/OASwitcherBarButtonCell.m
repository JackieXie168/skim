...
RCS_ID("$Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniAppKit/Widgets.subproj/OASwitcherBarButtonCell.m,v 1.6 2004/02/10 04:07:38 kc Exp $");
...
//#warning RDR: Having trouble putting together on/off state and highlight state the right way; see comment.
    ...
    if (isSelected && ![[controlView window] isKeyWindow])
        ...
        tintHighlightIndex = (2 * OACurrentControlTint() * isSelected) + [self isHighlighted];
