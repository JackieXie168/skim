...
RCS_ID("$Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniAppKit/Widgets.subproj/OAPatternColorPicker.m,v 1.3 2004/02/10 04:07:37 kc Exp $");
...
{
    // Look up the default system 'image' icon
    return [[NSWorkspace sharedWorkspace] iconForFileType:@"tiff"];
}
