...
//
// $Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniFoundation/OFPendingMethodList.h,v 1.6 2003/01/15 22:51:50 kc Exp $
...
static inline void OFQueueMethod(OFPendingMethodList *list, Class aClass, SEL sel, IMP imp, const char *types)
{
    ...
    } else if (list->list->method_count == list->size) {
        list->size *= 2;
