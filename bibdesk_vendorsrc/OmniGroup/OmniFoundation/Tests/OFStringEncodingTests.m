...
RCS_ID("$Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniFoundation/Tests/OFStringEncodingTests.m,v 1.3 2004/02/10 04:07:48 kc Exp $");
...
- (void)testRFC2047EncodedWord
{
    ...
    shouldBeEqual([s asRFC2047EncodedWord], @"=?UTF-16BE?B?/v/+TP5M/kz+TA==?=");
    // NB: The above test includes the BOM in the encoding, although it's redundant. A better (shorter) valid encoding would be =?UTF-16BE?B?/kz+TP5M/kw=?=  (no BOM).
