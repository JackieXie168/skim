...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2006-09-07/OmniGroup/Frameworks/OmniFoundation/Tests/OFArrayTests.m 79087 2006-09-07 23:37:02Z kc $");
...
#define NNUM 12
   ...
   // NSLog(@"b = %@", [b description]);
    ...
    NSMutableArray *acopy = [NSMutableArray arrayWithArray:a];
    NSMutableArray *bcopy = [NSMutableArray arrayWithArray:b];
    for(ix = 0; ix < NNUM; ix++) {
        unsigned c0, c1;
