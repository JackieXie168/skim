...
static malloc_zone_t *_OFClobberDetectionZoneCreate();
...
static volatile void _OFClobberAbort(OFClobberDetectionZone *z)
{
    if (z)
...
malloc_zone_t *OFClobberDetectionZoneCreate()
{
    malloc_zone_t *zone;
