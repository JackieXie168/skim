...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2006-09-07/OmniGroup/Frameworks/OmniFoundation/DataStructures.subproj/OFRationalNumber.m 73710 2006-03-27 23:59:38Z wiml $");
...
struct OFRationalNumberStruct OFRationalFromDouble(double d)
{
    ...
    m = ldexp(frexp(fabs(d), &exp), mbits);
    OFRationalFromPartsExp(&r, m, 1, exp - mbits, d<0);
