...
RCS_ID("$Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniFoundation/DataStructures.subproj/OFBTree.m,v 1.10 2004/02/10 04:07:42 kc Exp $")
...
void _OFBTreeSimpleAdd(OFBTree *btree, OFBTreeNode *node, void *insertionPoint, void *value)
{
    void *end;
...
"*/
void _OFBTreeSplitAdd(OFBTree *btree, void *value) 
{
    OFBTreeNode *node;
    void *insertionPoint;
    OFBTreeNode *right;
...
BOOL _OFBTreeAdd(OFBTree *btree,  void *value)
{
    OFBTreeNode *node;
