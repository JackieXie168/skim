...
//
// $Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniFoundation/Locks.subproj/OFSimpleLock-ppc.h,v 1.7 2003/01/15 22:51:58 kc Exp $
...
OFSimpleLockTry(OFSimpleLockType *simpleLock)
{
    ...
    // Require all previous instructions (but not memory accesses) to finish before continuing.  I'm not exactly sure why we do this, but the PPC manual suggests it.
    asm volatile ("isync");
