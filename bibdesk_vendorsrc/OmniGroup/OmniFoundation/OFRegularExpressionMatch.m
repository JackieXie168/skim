...
RCS_ID("$Header: /Network/Source/CVS/OmniGroup/Frameworks/OmniFoundation/OFRegularExpressionMatch.m,v 1.19 2003/01/15 22:51:50 kc Exp $")
...
- (NSString *)subexpressionAtIndex:(unsigned int)index;
{
    ...
    if (range.location == INVALID_SUBEXPRESSION_LOCATION)
        return nil;
