...
- (void)setCurrentClientRecord:(OAPreferenceClientRecord *)clientRecord
{
    ...
    newWindowFrame = [NSWindow frameRectForContentRect:NSMakeRect(NSMinX(windowFrame), NSMaxY(windowFrame) - newWindowHeight, MAX(NSWidth(windowFrame), NSWidth(controlBoxFrame)), newWindowHeight) styleMask:[window styleMask]];
