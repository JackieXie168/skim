...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2006-09-07/OmniGroup/Frameworks/OmniFoundation/CoreServicesExtensions/OFResourceFork.m 66170 2005-07-28 17:40:10Z kc $")
...
+ (NSArray *) stringsFromSTRResourceHandle: (Handle) resourceHandle;
{
    ...
    while (stringCount--) {
        ...
        thisString = [[NSString alloc] initWithCString: str length: thisStringLength];
