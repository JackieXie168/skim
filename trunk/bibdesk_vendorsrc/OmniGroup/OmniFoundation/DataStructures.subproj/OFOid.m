...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2006-09-07/OmniGroup/Frameworks/OmniFoundation/DataStructures.subproj/OFOid.m 68913 2005-10-03 19:36:19Z kc $")
...
- initWithString:(NSString *)aString
{
    ...
    unichar *buffer;
    const unichar *p;
    unsigned int length, index, maxIndex;
    ...
    maxIndex = MIN(sizeof(bytes), length/2);
